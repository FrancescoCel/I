...
def getLocation():
    """
    Funzione che permette di acquisire dall'utente il nome della sua locazione,
    e verificare che esso sia corretto
    
    Returns
    -------
    goodLoc: geopy.location.Location
        Posizione che l'utente ha inserito
    """
    goodLoc = False
